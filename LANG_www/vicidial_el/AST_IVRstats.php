...
echo "<a href=\"./admin.php?ADD=3111&group_id=$group[0]\">ΤΡΟΠΟΠΟΙΗΣΗ</a> | ";
echo "<a href=\"./admin.php?ADD=999999\">ΑΝΑΦΟΡΕΣ</a> | ";
echo "<a href=\"./AST_CLOSERstats.php?query_date=$query_date&end_date=$end_date&shift=$shift$groupQS\">ΑΝΑΦΟΡΑ CLOSER</a> \n";
echo "</FONT>\n";
