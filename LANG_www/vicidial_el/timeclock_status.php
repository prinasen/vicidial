...
<title>ADMINISTRATION:Ώρα ρολόι Status
<?php
...
<FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B>Ώρα ρολόι Status for <?php echo $user_group ?></TD><TD ALIGN=RIGHT> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<?php 
echo "<a href=\"./timeclock_report.php\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>TIMECLOCK REPORT</a> | ";
echo "<a href=\"./admin.php?ADD=311111&user_group=$user_group\"><FONT FACE=\"ARIAL,HELVETICA\" COLOR=WHITE SIZE=2><B>ΟΜΑΔΑ ΧΡΗΣΤΩΝ</a>\n";
?>
</TD></TR>
