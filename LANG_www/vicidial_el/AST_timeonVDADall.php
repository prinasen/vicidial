...
if ($UGdisplay > 0)
	{
	$select_list .= "Select Ομάδα Χρήστη:<BR>";
...
##### NOT INBOUND ONLY ###
	...
	if ($adastats>1)
		...
		echo "<TD ALIGN=RIGHT><a href=\"$PHP_SELF?$groupQS&RR=4&DB=$DB&adastats=1\"><font size=1>- min </font></a><font size=2>&nbsp; <B>MAX ΕΠΙΠΕΔΟ:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $maxDIALlev &nbsp; </TD>";
	...
	echo "<TR>";
	echo "<TD ALIGN=RIGHT><font size=2><B>HOPPER ΕΠΙΠΕΔΟ:</B></TD><TD ALIGN=LEFT><font size=2>&nbsp; $HOPlev &nbsp; &nbsp; </TD>";
