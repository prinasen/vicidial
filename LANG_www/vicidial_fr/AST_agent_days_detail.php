...
if ($file_download < 1)
	...
	echo "<TITLE>Agent Jours Etat Report</TITLE></HEAD><BODY BGCOLOR=white marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
if (strlen($group[0]) < 1)
	...
	if ($file_download < 1)
		{
		echo "Agent Jours Etat Report: $user                     $NOW_TIME\n";
...
if (strlen($user) > 1)
	...
	{echo " <a href=\"./admin.php?ADD=0\">UTILISATEURS</a> | \n";}
