...
if (strlen($group[0]) < 1)
	...
	if (eregi("YES",$include_rollover))
		...
		if ( ($DROPcalls < 1) or ($CIcallsRAW < 1) )
			{$inDROPRISPOSTApercent = '0';}
		else
			{
			$inDROPRISPOSTApercent = (($DROPcallsRAW / $CIcallsRAW) * 100);
	...
	$OUToutput .= "\n";
	$OUToutput .= "---------- NESSUNA RISPOSTA AUTO-DIAL\n";
	...
	$OUToutput .= "Totale Chiamate Senza Risposta - occupato, disconnesso, fuori posto...: $NAcalls  $NApercent%\n";
