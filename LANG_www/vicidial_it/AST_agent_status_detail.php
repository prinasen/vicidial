...
if ($file_download < 1)
	...
	echo "<TITLE>Agent Status Dettagliata Report</TITLE></HEAD><BODY BGCOLOR=white marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
if ( (strlen($group[0]) < 1) or (strlen($user_group[0]) < 1) )
	...
	if ($file_download < 1)
		{
		echo "Agent Status Dettagliata Report                     $NOW_TIME\n";
