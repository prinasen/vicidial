...
if ($file_download < 1)
	...
	echo "<TITLE>Agent Situación días Report</TITLE></HEAD><BODY BGCOLOR=white marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
if (strlen($group[0]) < 1)
	...
	if ($file_download < 1)
		{
		echo "Agent Situación días Report: $user                     $NOW_TIME\n";
		...
		{
		$file_output .= "Agent Situación días Report: $user                     $NOW_TIME\n";
...
if (strlen($user) > 1)
	...
	{echo " <a href=\"./admin.php?ADD=0\">USUARIOS</a> | \n";}
