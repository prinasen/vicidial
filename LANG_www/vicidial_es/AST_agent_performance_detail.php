...
echo "<TITLE>Agent Performance Detalle</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
...
echo "Agent Performance Detalle                        $NOW_TIME\n";
