...
if ($ACTION == 'alt_phone_change')
{
	...
	if ( (strlen($stage)<1) || (strlen($called_count)<1) || (strlen($lead_id)<1)  || (strlen($phone_number)<1) )
		{
		$channel_live=0;
		echo "TELEFONE ALTERNATIVO NUMERO STATUS NOT CHANGED\n";
		...
		echo "TELEFONE ALTERNATIVO NUMERO STATUS CHANGED\n";
		}
}
		...
		if ( (ereg('ACCTID',$vtiger_search_category)) or (ereg('ACCOUNT',$vtiger_search_category)) )
			...
			if ($VIDcount > 0)
				...
				if (ereg('Y',$vtiger_status_call))
					...
					# Date of Ultimo Attempt, Date of Ultimo Non-Contact, Date of Ultimo Contact, Date of Ultimo Sale
