...
echo "<BODY BGCOLOR=white marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
	...
	if ($ACTION == 'refresh')
	{
		...
		#	$AexternalDEAD=$row[0];
			...
			$Ashift_logout=0;
			if ( ( (ereg("ALL",$shift_enforcement)) and (!ereg("OFF|開始",$VU_agent_shift_enforcement_override)) ) or (ereg("ALL",$VU_agent_shift_enforcement_override)) )
				{
				$shift_ok=0;
	...
	#	echo "$channels_list|";
		...
		{
			$counter++;
			$countecho = "$countecho$渠道A[$counter] ~";
		#	echo "$渠道A[$counter] ~";
		}
