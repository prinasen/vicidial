...
if( (strlen($user)<2) or (strlen($pass)<2) or (!$auth) or ($relogin == 'YES') )
	...
	echo "<title>astGUIclient web client: 登入</title>\n";
	echo "</head>\n";
...
// ################################################################################
// LIVE TRUNK LIST FOR 掛斷/HIJACK MENU FUNCTIONS
...
// ################################################################################
// LIVE LOCAL LIST FOR 掛斷/HIJACK MENU FUNCTIONS
	...
	function liverecording_send_recording(taskvar,taskchan,taskspan,taskfile) 
		...
		if (xmlhttp) 
			...
			if (taskvar == 'StopMonitor')
				...
				filename = taskfile;
				var rec_stop_html = "<a href=\"#\" onclick=\"liverecording_send_recording('Monitor','" + monitorchannelvalue + "','" + taskspan + "','');return false;\">錄音";
	...
	function conf_send_recording(taskconfrectype,taskconfspan,taskconfrec,taskconffile) 
		...
		if (xmlhttp) 
			...
			if (taskconfrectype == 'StopMonitorConf')
				...
				var channelrec = "Local/" + taskconfrec + "@" + ext_context;
				var conf_rec_start_html = "<a href=\"#\" onclick=\"conf_send_recording('MonitorConf','" + taskconfspan + "','" + taskconfrec + "','');return false;\">錄音</a>";
				document.getElementById(taskconfspan).innerHTML = conf_rec_start_html;
				}
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	pause();
					...
					if (live_calls > 0)
						{
						var live_calls_HTML = "<font face=\"Arial,Helvetica\"><B>通話號碼清單:</B></font><BR><table width=100%><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">進端通道</td><td><font class=\"log_title\">遠端通道</td><td><font class=\"log_title\">錄音</td><td><font class=\"log_title\">掛斷</td><td><font class=\"log_title\"轉接</td><td><font class=\"log_title\">駐留</td></tr>";
						...
						while (loop_ct < live_calls)
							...
							if (recLIST.match(regx)) 
								...
								{live_calls_HTML = live_calls_HTML + "<span id=\"recordlive" + loop_ct + "\"><a href=\"#\" onclick=\"liverecording_send_recording('Monitor','" + channelfieldBtrunk_array[1] + "','recordlive" + loop_ct + "');return false;\">錄音</span>";}
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (out_calls > 0)
						{
						var out_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> 通話日期\/時間</td><td><font class=\"log_title\">號碼</td><td align=right><font class=\"log_title\">長度 (M:SS)</td><td><font class=\"log_title\"> </td></tr>"
					...
					if (in_calls > 0)
						{
						var in_log_HTML = "<table width=580><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\"> 通話日期\/時間</td><td><font class=\"log_title\">IN-NUMMER</td><td COLSPAN=2><font class=\"log_title\">CALLERID</td><td align=right><font class=\"log_title\">長度</td><td><font class=\"log_title\"> </td></tr>"
		...
		if (xmlhttp) 
			...
			xmlhttp.onreadystatechange = function() 
				...
				//	alert(xmlhttp.responseText);
					...
					if (parked_count > 0)
						{
						var park_HTML = "<table width=600><tr bgcolor=#E6E6E6><td><font class=\"log_title\">#</td><td><font class=\"log_title\">CHANNEL<BR>&nbsp; 撥號 ID</td><td><font class=\"log_title\">駐留ED BY<BR>&nbsp; 駐留ED TIME</td><td><font class=\"log_title\">掛斷</td><td><font class=\"log_title\"轉接</td><td><font class=\"log_title\">接起</td></tr>"
...
<span style="position:absolute;left:80px;top:12px;z-index:42;" id="MainXfeRBox">
    ...
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 來電轉接</b> <BR>通話已被轉接: <span id="MainXfeRChanneL">渠道</span><BR></tr>
...
<span style="position:absolute;left:80px;top:12px;z-index:43;" id="LocalDialBox">
    <table border=0 bgcolor="#FFFFCC" width=600 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 撥給LOCAL分機</b> <BR>電話來源: <span id="LocalDialChanneL">渠道</span><BR></tr>
...
<span style="position:absolute;left:40px;top:12px;z-index:41;" id="ParkDisplayBox">
    <table border=0 bgcolor="#FFFFCC" width=640 height=500 cellpadding=3><TR><TD COLSPAN=3 ALIGN=CENTER><b> 駐留ED 撥號S:</b> <div class="scroll_park" id="ParkDisplayContents"></div>
...
<tr><td align=center><a href="#" onclick="showParkDisplay('ParkDisplayBox');return false;"><font face="Arial,Helvetica"><B>駐留ED 撥號S</B></a>:  <span id="parked_calls_count">0</span> &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="#" onclick="showLocalDial('LocalDialBox');return false;"><font face="Arial,Helvetica"><B>LOCAL撥打分機</a></td></tr>
...
<tr><td colspan=3>
<a href="#" onclick="pause();return false;">停止</a> | <a href="#" onclick="start();return false;">開始</a> &nbsp; &nbsp; 更新比例: <span id="refresh_rate">1000 ms</span> <a href="#" onclick="faster();return false;">較快速</a> | <a href="#" onclick="slower();return false;">較慢速</a></p>
