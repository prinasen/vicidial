		...
		if (taskMDstage == "start") 
			...
			if (alt_phone_dialing == 1)
				...
				if (document.vicidial_form.DiaLAltPhonE.checked==true)
					...
					var man_status = "撥打其他電話號碼: <a href=\"#\" onclick=\"ManualDialOnly('MaiNPhonE')\"><font class=\"preview_text\">主要電話</font></a> or <a href=\"#\" onclick=\"ManualDialOnly('ALTPhonE')\"><font class=\"preview_text\">其他電話</font></a> or <a href=\"#\" onclick=\"ManualDialOnly('AddresS3')\"><font class=\"preview_text\">地址3</font></a> or <a href=\"#\" onclick=\"ManualDialAltDonE()\"><font class=\"preview_text_red\">結束紀錄</font></a>"; 
