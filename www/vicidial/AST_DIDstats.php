...
echo "<SELECT SIZE=5 NAME=group[] multiple>\n";
	...
	while ($groups_to_print > $o)
	{
		if ($groups[$o] == $group) {echo "<option selected value=\"$groups[$o]\">$group_patterns[$o] - $group_names[$o]</option>\n";}
		  else {echo "<option value=\"$groups[$o]\">$group_patterns[$o] - $group_names[$o]</option>\n";}
		$o++;
	}
echo "</SELECT>\n";
echo "</TD><TD align=center valign=top>\n";
